    ...
    inputChangeListener(contextData) {
        if (this.input) {
            ...
            this.input.addEventListener(const_string_1.EventType.input, () => {
                ...
                this.dirty();
                if (this.modelAttr)
                    util_1.setData(this.modelAttr.value, (_a = this.input) === null || _a === void 0 ? void 0 : _a.value, contextData);
            });
        }
    }
    selectSetup(states) {
        ...
        if (this.select) {
            this.select.addEventListener(const_string_1.EventType.change, () => {
                ...
                if ((_a = this.select) === null || _a === void 0 ? void 0 : _a.multiple) {
                    if (this.modelAttr)
                        util_1.setData(this.modelAttr.value, this.selectValues, contextData);
                }
                else {
                    if (this.modelAttr)
                        util_1.setData(this.modelAttr.value, (_b = this.select) === null || _b === void 0 ? void 0 : _b.value, contextData);
                }
                this.dirty();
            });
        }
